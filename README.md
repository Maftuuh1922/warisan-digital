...
*A digital platform for authenticating and promoting Indonesia's rich batik heritage through QR code verification.*

[cloudflarebutton]

## About The Project

Warisan Digital is a sophisticated web application designed to bridge the gap between traditional batik artisans and the modern consumer. The platform serves three key user groups: Artisans, Administrators, and the Public.
...
This system aims to combat counterfeit products, preserve cultural knowledge, and economically empower local artisan communities.

## Key Features

### Web Platform (For Artisans & Admins)
...
### Mobile App (For Public Users)
- **QR Code Scanner:** Scan QR codes on batik products to instantly verify authenticity.
...
1.  **Clone the repository:**
    ```sh
    git clone https://github.com/your-username/warisan_digital.git
    cd warisan_digital
    ```
